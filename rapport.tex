...
Les premières formes d'attaques par clé USB reposaient sur l'exécution automatique (\textit{autorun}) de fichiers malveillants lors de la connexion du périphérique. Le ver \textbf{Conficker} (2008) et le célèbre virus \textbf{Stuxnet} (2010) ont tous deux utilisé des clés USB comme vecteur de propagation, ciblant notamment les installations industrielles iraniennes d'enrichissement d'uranium.
